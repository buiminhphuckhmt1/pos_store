            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="#" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder" style="text-transform:uppercase;">{{ config('app.name') }}</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST" autocomplete="off">
              	@csrf
                <div class="mb-3">
